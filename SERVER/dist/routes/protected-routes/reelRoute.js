...
const reels_1 = __importDefault(require("../../controllers/Reels-controller/reels"));
const multer_1 = __importStar(require("multer"));
const render_1 = __importDefault(require("../../controllers/others/render"));
const tsyringe_1 = require("tsyringe");
let ReelsRoutes = class ReelsRoutes {
    constructor(reelsController, renderController) {
...
ReelsRoutes = __decorate([
    (0, tsyringe_1.autoInjectable)(),
    __metadata("design:paramtypes", [reels_1.default,
        render_1.default])
], ReelsRoutes);
