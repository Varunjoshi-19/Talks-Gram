        ...
        <>
            ...
            <div id={styles.editProfile}>
                ...
                <div style={{
                    ...
                    <div style={{ display: "flex", border: "none", width: "100%", flexDirection: "column", gap: "40px" }}>
                    ...
                    <div style={{
                        width: "100%", display: "flex", height: "30px"
                        , justifyContent: "center", alignItems: "center"
                    }} >
                        {message && <span style={{ color: "rgb(0, 250, 0)" }} >{message}</span>}
