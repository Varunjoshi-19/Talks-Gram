    ...
    return (
        <div>
            ...
            <div className={styles.profileContainer} >
                ...
                <div className={styles.profileInformation}>
                    ...
                    <div className={styles.profileImage} >
                        ...
                        <img onClick={() => {
                            ...
                            style={{ borderRadius: "50%", objectFit: "contain", cursor: `${uploadedStory ? "pointer" : "default"}` }}
                ...
                {selectedOption === "SAVED" && <div style={{ position :"relative",  left : "140px", width : "60vw" ,
                    display : "flex" , justifyContent : "center" , alignItems : "center",fontSize : "1.5rem", fontWeight :"bolder"
                 }} >
                 <span>NO SAVED</span>
                </div>
                }
